...
<hr>
    ...
    <tbody>
            ...
            <tr>
            <td>
              <?php echo $_SESSION["newProj"][0]; ?>
            </td>
            <td>
              <?php echo $_SESSION["newProj"][1]; ?>
          </td>
          <td>
          <?php echo $_SESSION["newProj"][2]; ?>
        </td>
        <td>
          <?php
      ...
      <td>
<?php echo$_SESSION["newProj"][4]; ?>
    </td>
    <td>
  <?php echo $_SESSION["newProj"][5]; ?>
      </td>
      <td>
      <?php echo $_SESSION["newProj"][6] ?>
        </td>
